...
export function TabBar({ active }: { active: 'inbox' | 'expenses' }) {
  return <nav aria-label="Main navigation" className="fixed inset-x-0 bottom-0 z-30 border-t bg-background/95 px-4 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur dark:border-border">
